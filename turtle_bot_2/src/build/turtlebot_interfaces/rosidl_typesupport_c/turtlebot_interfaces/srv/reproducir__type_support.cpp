...
static const _Reproducir_Request_type_support_symbol_names_t _Reproducir_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlebot_interfaces, srv, Reproducir_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlebot_interfaces, srv, Reproducir_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtlebot_interfaces, srv, Reproducir_Request)() {
  return &::turtlebot_interfaces::srv::rosidl_typesupport_c::Reproducir_Request_message_type_support_handle;
}
...
static const _Reproducir_Response_type_support_symbol_names_t _Reproducir_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlebot_interfaces, srv, Reproducir_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlebot_interfaces, srv, Reproducir_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtlebot_interfaces, srv, Reproducir_Response)() {
  return &::turtlebot_interfaces::srv::rosidl_typesupport_c::Reproducir_Response_message_type_support_handle;
}
...
static const _Reproducir_type_support_symbol_names_t _Reproducir_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlebot_interfaces, srv, Reproducir)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlebot_interfaces, srv, Reproducir)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, turtlebot_interfaces, srv, Reproducir)() {
  return &::turtlebot_interfaces::srv::rosidl_typesupport_c::Reproducir_service_type_support_handle;
}
