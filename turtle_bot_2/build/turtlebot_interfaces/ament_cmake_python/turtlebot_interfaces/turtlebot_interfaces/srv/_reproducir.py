...
class Metaclass_Reproducir_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('turtlebot_interfaces')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_Reproducir(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'turtlebot_interfaces.srv.Reproducir')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from turtlebot_interfaces.srv import _reproducir
...
class Reproducir(metaclass=Metaclass_Reproducir):
    from turtlebot_interfaces.srv._reproducir import Reproducir_Request as Request
    from turtlebot_interfaces.srv._reproducir import Reproducir_Response as Response
